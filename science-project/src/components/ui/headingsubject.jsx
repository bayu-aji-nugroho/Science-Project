export default function HeadingSubject({title,infor,link }){
    return (
        <div className="mb-3 md:flex bg-[url('/subject/Math.png')] shadow-2xl shadow-gray-900">
            <div className="text-white p-5 bg-orange-700  md:basis-3/4 lg:basis-1/2 md:rounded-br-full md:pl-10">
